        ...
        <Card className="border-0 shadow-none bg-background">
          ...
          <CardContent className="px-0 pb-0 space-y-8">
            ...
            {currentStep === 3 && (
              <>
                <div className="mb-6 p-4 border rounded-lg bg-muted/50">
                  <p className="text-sm font-medium mb-1">Define Your Ideal Customer Profile</p>
                  <p className="text-sm text-muted-foreground">
                    Select multiple options to help us find the right prospects for your business.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    ...
                    <MultiSelect
                      options={JOB_TITLES}
                      onValueChange={(values) => setFormData({ ...formData, targetJobTitles: values })}
                  ...
                  <div className="space-y-3">
                    ...
                    <MultiSelect
                      options={INDUSTRIES}
                      onValueChange={(values) => setFormData({ ...formData, targetIndustries: values })}
                  ...
                  <div className="space-y-3">
                    <Label className="text-sm font-medium">Target Company Sizes</Label>
                    <MultiSelect
                      options={COMPANY_SIZES}
                      onValueChange={(values) => setFormData({ ...formData, targetCompanySizes: values })}
                  ...
                  <div className="space-y-3">
                    ...
                    <MultiSelect
                      options={LOCATIONS}
                      onValueChange={(values) => setFormData({ ...formData, targetLocations: values })}
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                <div className="space-y-3">
                  <Label htmlFor="preferredTone" className="text-sm font-medium">
                    Email Tone
                  </Label>
                ...
                <div className="space-y-3">
                  <Label htmlFor="emailSignature" className="text-sm font-medium">
                    Email Signature
                  </Label>
                  <Textarea
                    id="emailSignature"
            ...
            {currentStep === 5 && (
              <div className="space-y-6">
                <div className="space-y-3">
                  <Label htmlFor="autoSendCriteria" className="text-sm font-medium">
                    Auto-Send Criteria
                    <span className="text-muted-foreground font-normal ml-2">(Optional)</span>
                  </Label>
                  <Textarea
                  ...
                  <p className="text-xs text-muted-foreground">
                    Leave blank to manually review all emails. You can adjust automation rules later in settings.
                  </p>
                </div>

                <div className="border rounded-lg p-4 bg-muted/50">
                  <h4 className="font-medium text-sm mb-2">Default Automation</h4>
                  <p className="text-sm text-muted-foreground">
