...
export function SearchResultsModal({
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      toast.success(
        `Successfully imported ${selectedIds.length} ${searchType === "people" ? "people" : "organizations"}`
      );
      onClose();
      setSelectedIds([]);
      ...
      <DialogContent className="max-w-6xl max-h-[80vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle>
            ...
            {searchType === "people" ? "people" : "organizations"} shown)
          </DialogTitle>
          <DialogDescription>
            Review and select the{" "}
            {searchType === "people" ? "people" : "organizations"} you want to
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              ...
                              <Badge
                                variant={
                                  isOrganization ? "secondary" : "default"
                                }
                                className="text-xs"
                              >
